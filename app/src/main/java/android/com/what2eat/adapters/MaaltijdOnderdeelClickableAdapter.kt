 ...
 * het weergeven van een lijst van [MaaltijdOnderdeel] (inclusief clickListener ([MaaltijdOnderdeelListener]]). Inclusief
 * een diffCallBack ([MaaltijdOnderdeelDiffCallback] voor betere RecyclerView-performantie)
