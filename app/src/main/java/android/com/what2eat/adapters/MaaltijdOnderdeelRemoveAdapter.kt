...
import android.com.what2eat.databinding.MaaltijdonderdeelRemoveItemViewBinding
 ...
 * het weergeven van een lijst van [MaaltijdOnderdeel] met een verwijder-button
 * (inclusief clickListener ([MaaltijdOnderdeelListener]]). Inclusief een diffCallBack
 ...
 */
class MaaltijdOnderdeelRemoveAdapter(val clickListener: MaaltijdOnderdeelListener) : ListAdapter<MaaltijdOnderdeel, MaaltijdOnderdeelRemoveAdapter.ViewHolder>(MaaltijdOnderdeelDiffCallback()){
    /**
     ...
     */
    class ViewHolder private constructor(val binding: MaaltijdonderdeelRemoveItemViewBinding): RecyclerView.ViewHolder(binding.root){
        companion object {
            /**
            ...
            fun from(parent: ViewGroup): ViewHolder {
                ...
                val binding = MaaltijdonderdeelRemoveItemViewBinding.inflate(layoutInflater, parent, false)
