[app](../../index.md) / [android.com.what2eat.fragments](../index.md) / [MaaltijdOnderdeelDetailFragment](index.md) / [onCreate](./on-create.md)
...
`savedInstanceState` - Bundel die gebruikt wordt om data terug in [MaaltijdOnderdeelDetailFragment](index.md) te initialiseren.